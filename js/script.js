...
/*
 * Initialize arrays.
 * It store items as empty arrays or if contain stored items initialize them all.
*/
...
/*
 * Once button "new-item-button" is clicked, an to-do item is created. If the button is pressed without a text on it
 * there is an alert called to fill it in.
 */
document.getElementById("new-item-button").onclick = function() {
	...
	if(itemText) {
		...
		updateStorage();
 		...
 		alert('Preencha o campo com alguma tarefa, Champs');
 	}
}
...
/*
 * Load the lists with the elements inside the arrays
*/
function loadItems() {
...
//Function to shows a task item is checked as completed
...
//Function that adds a new task item with "complete" checkin and a remove button
function addItemToDOM(itemText, completed) {
	//Creates a new line
	const item = document.createElement('li');
	item.innerText = itemText;
	
	//Creates a news buttons at the new line
	const buttons = document.createElement('div');
	buttons.classList.add('buttons');
	
	//Especify the remove buttons at the new line and its functionalities
	const removeButton = document.createElement('button');
	removeButton.classList.add('remove');
	removeButton.innerHTML = removeIcon;
	removeButton.onclick = removeItem;
	
	//Especify the complete buttons at the new line and its functionalities
	const completeButton = document.createElement('button');
	completeButton.classList.add('complete');
	completeButton.innerHTML = completeIcon;
	completeButton.onclick = completeItem;

	//Inserts both buttons created at the new task-line 
